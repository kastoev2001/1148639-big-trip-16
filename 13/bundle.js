...
const generateDescription = function () {
  ...
  const randomIndex = (0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, DESCRIPTIONS.length - 1);
...
const generateType = function () {
  const randomIndex = (0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, _const__WEBPACK_IMPORTED_MODULE_2__.TYPE_POINT.length - 1);
...
const generateCities = function () {
  ...
  const randomIndex = (0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, CITIES.length - 1);
  return CITIES[randomIndex];
};

const generateService = function () {
  const services = [[{
    id: (0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.generateId)(),
    ...
    price: 30,
    isChecked: Boolean((0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)())
  }, {
    id: (0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.generateId)(),
  ...
  const randomIndex = (0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, services.length - 1);
...
const generatePoint = () => {
  const initialPrice = (0,_utils_commonds__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(20, 100);
  return {
    pics: renserPics(),
    type: generateType(),
    city: generateCities(),
...
class EditPointWiew extends _site_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class EmptyPointsWiew extends _site_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(text) {
    super();
...
class TripEventsView extends _site_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/* harmony import */ var _utils_point__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils/point */ "./src/utils/point.js");
...
(0,_utils_render__WEBPACK_IMPORTED_MODULE_10__.render)(tripControlsNavigationElement, new _view_site_menu_view__WEBPACK_IMPORTED_MODULE_1__["default"]().element, _utils_render__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFORE_END);
const tripEventsComponent = new _view_site_trip_events_view__WEBPACK_IMPORTED_MODULE_4__["default"]();
const pageMainElement = document.querySelector('.page-main');
const tripEvents = pageMainElement.querySelector('.trip-events');
(0,_utils_render__WEBPACK_IMPORTED_MODULE_10__.render)(tripEvents, new _view_site_sorting_view__WEBPACK_IMPORTED_MODULE_3__["default"]().element, _utils_render__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFORE_END);
...
const renderPoint = (eventList, point) => {
  ...
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_10__.render)(eventList, pointComponent.element, _utils_render__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFORE_END);
};

if (points.length === 0) {
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_10__.render)(tripEvents, new _view_site_empty_view__WEBPACK_IMPORTED_MODULE_5__["default"](EmptyFiter.EVERYTHING).element, _utils_render__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFORE_END);
} else {
  const sortedPoints = (0,_utils_point__WEBPACK_IMPORTED_MODULE_11__.sortPoints)(points);
  const filters = (0,_mock_filter__WEBPACK_IMPORTED_MODULE_8__.generateFilter)(points);
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_10__.render)(tripMainElement, new _view_site_joint_trip_view__WEBPACK_IMPORTED_MODULE_0__["default"](sortedPoints).element, _utils_render__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.AFTER_BEGIN);
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_10__.render)(tripControlsFiltersElements, new _view_site_filter_view__WEBPACK_IMPORTED_MODULE_2__["default"](filters).element, _utils_render__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFORE_END);
  sortedPoints.forEach(point => {
    renderPoint(tripEventsComponent.element, point);
  });
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_10__.render)(tripEvents, tripEventsComponent.element, _utils_render__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFORE_END);
}
})();
